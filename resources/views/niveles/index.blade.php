                ...
                <table class="table table-hover table-head-fixed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $nivel->nombre }}</td>
                            <td>
                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editModal{{ $nivel->nivel_id }}">Editar</button>
                                <div class="modal fade" id="editModal{{ $nivel->nivel_id }}" tabindex="-1">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                @include('partials.niveles.form_edit', ['nivel' => $nivel])
                                            </div>
                                        </div>
                                    </div>
                                </div>
